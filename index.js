...
const botonMostrarCarrito = document.querySelector("#apertura-carrito");
const botonOcultarCarrito = document.querySelector("#cierre-carrito");
...
const aplicarDescuento = () => {
    if (inputDescuento.checked) {
        resultadoDescuento = -subtotalEnNumero * 0.10;
